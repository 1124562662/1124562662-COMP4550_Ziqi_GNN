...
public:
    ActionFluent(ParametrizedVariable const& source,
        ...
        // 4550 tmp
        // source.print(std::cout);std::cout<<"     -action"<<std::endl;
    }
...
public:
    ...
    void getReplacements(std::vector<std::string>& parameterNames,
                         ...
                         Instantiator* inst);
    // void write_in_file(std::string quantifier_name, std::string str,
    //                    ParameterList* _paramList, LogicalExpression* expr);
};
...
public:
    Sumation(ParameterList* _paramList, LogicalExpression* _expr)
        ...
        // 4550 tmp
     //   this->write_in_file("Sumation:", "sum-fluent_name:", _paramList, _expr);
        // 4550
    }
...
public:
    Product(ParameterList* _paramList, LogicalExpression* _expr)
        : Quantifier(_paramList, _expr) {
        // 4550
        //this->write_in_file("Product:", "prod-fluent_name:", _paramList, _expr);
        // 4550
    }
...
public:
    UniversalQuantification(ParameterList* _paramList, LogicalExpression* _expr)
        : Quantifier(_paramList, _expr) {
        // 4550
       // this->write_in_file("UniversalQuantification:",
                      //      "Universal-fluent_name:", _paramList, _expr);
...
public:
    ExistentialQuantification(ParameterList* _paramList,
        ...
        : Quantifier(_paramList, _expr) {
        // 4550
       // this->write_in_file("ExistentialQuantification:",
                         //   "Existential-fluent_name:", _paramList, _expr);
        // 4550
    }
